...
%     title(titlestring,'color','k');
    ...
    titlestring='boundaries showing the SKIZ of each cell Water-Dist where oversegmentation';
    title(titlestring,'color','k');axis ('image','off');
...
%         axis([236 738 96 572]);
       ...
       titlestring='Modified regional minima superimposed on original image';  %Modified regional minima superimposed on original image 
    ...
    title(titlestring,'color','k');axis ('image','off');colorbar;
        ...
        Bin_Mask3(LDist_Transf2 == 0) = 0;
       figure, imagesc(Bin_Mask3);titlestring='watershed of dist transform of minima imposed';
    title(titlestring,'color','k');axis ('image','off');colormap gray;
    
     figure, imshowpair(originalImage{k},LDist_Transf2 == 0,'falsecolor');titlestring='Final result of cell separation ';
    title(titlestring,'color','k');axis ('image','off');colormap gray;colorbar;
...
for k = 1 :25:Nb_Masks
    ...
    Thresh_solidity = 0.95;    %  SIM04  thres =0.8926 smallest other .95, 0.9 for hela2
    ...
    for k = 1 : numberOfBoundaries
        ...
        plot(thisBoundary(:,2), thisBoundary(:,1), 'g', 'LineWidth', 0.7);
    end
    hold off;
    ...
    for k = 1 : numberOfcells
        ...
        text(cellCentroid(1) + labelShiftX, cellCentroid(2), num2str(k),'color','y', 'FontSize', 10);
    end
